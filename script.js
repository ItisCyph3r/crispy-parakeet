...
function drawText() {
    ...
    if(frameNumber >= 250 && frameNumber < 500){
        context.fillStyle = `rgba(45, 45, 255, ${opacity})`;
        drawTextWithLineBreaks(["To my wonderful, beautiful, ever loving, stubborn,", "sharp mouthed WOMAN 🥰💜"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        // context.fillText("To my wonderful, beautiful, ever loving, stubborn", canvas.width/2, canvas.height/2);
